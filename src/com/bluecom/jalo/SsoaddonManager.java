...
/**
 * This is the extension manager of the Ssoaddon extension.
 */
public class SsoaddonManager extends GeneratedSsoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SsoaddonManager.class.getName());
	 ...
	 */
	public static SsoaddonManager getInstance()
	{
		return (SsoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SsoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SsoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SsoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SsoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SsoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
